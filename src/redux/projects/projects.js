...
const initialState = {
  projects: [
    ...
    },
    {
      ...
      title: "Book Store",
      description:
        "This Bookstore allows users to: Display a list of books. Add a book. Remove a selected book.",
      langs: ["React", "Css", "Bootstrap"],
      btn: "see project",
    ...
    },
    {
      ...
      title: "A Todo List",
      description:
        "This Todo List allows users to: Add a task. Remove a selected task. Mark a task as complete.",
    ...
    },
    {
      ...
      title: "The Cocktail",
      description:
        "This is a mobile web app that provides information about the cocktail recipes. Users to like their favorite cocktails and give comments on the recipes.",
      langs: ["Html", "Css", "JavaScript"],
      btn: "see project",
