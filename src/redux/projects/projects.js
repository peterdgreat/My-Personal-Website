...
const initialState = {
  ...
  },
  {
    ...
    description: 'A web application for a company that provides commercial and scientific space travel services. The application  allow users to book rockets and join selected space missions.',
    langs: ['React',  'Css', 'Bootstrap'],
    btn: 'see project',
  ...
  },
  {
    id:'4',
    title: 'A Todo List',
    description: 'This Todo List allows users to: Add a task. Remove a selected task. Mark a task as complete.',
  ...
  },
  {
    id: '5',
    title: 'The Cocktail',
    description: 'This is a mobile web app that provides information about the cocktail recipes. Users to like their favorite cocktails and give comments on the recipes.',
    langs: ['Html', 'Css', 'JavaScript'],
    btn: 'see project',
  ...
  },
  {
    ...
    description: 'This is a simple website built for a conference event, users can view the past conference events and get information about upcoming events.',
